...
CAREERS_DATABASE += [
    _career(
        ...
        [{"skill_id": "python_core", "name": "Advanced Python & Scientific Computing", "level": 0.8, "critical": True},
         ...
         {"skill_id": "data_pipelines", "name": "ETL / ELT Pipeline Engineering", "level": 0.85, "critical": True},
    ...
    _career(
        ...
        [{"skill_id": "python_core", "name": "Python or JavaScript for Test Code", "level": 0.8, "critical": True},
         ...
         {"skill_id": "ci_testing", "name": "CI Test Pipelines", "level": 0.7, "critical": False}],
...
SKILLS_DATABASE = {
    ...
    "data_pipelines": {"id": "data_pipelines", "name": "ETL / ELT Pipeline Engineering", "category": "Data", "prerequisites": ["sql", "python_core"], "resources": []},
    ...
    "ci_testing": {"id": "ci_testing", "name": "CI Test Pipelines", "category": "Quality", "prerequisites": ["test_automation"], "resources": []},
