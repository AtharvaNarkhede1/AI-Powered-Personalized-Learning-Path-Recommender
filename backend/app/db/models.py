...
class LearnerProfileDB(Base):
    ...
    user_status = Column(String, default='Engineering Student')
    ...
    preferred_format = Column(String, default='project-based')
    learning_style = Column(String, default='practical')
    max_budget = Column(String, default='free-and-paid')
...
class SkillProficiencyDB(Base):
    ...
    evidence_source = Column(String, default='self_report')
...
class MilestoneDB(Base):
    ...
    youtube_extras = Column(JSON, default=list)
...
class LearnerModelDB(Base):
    ...
    affinities = Column(JSON, default=dict)
